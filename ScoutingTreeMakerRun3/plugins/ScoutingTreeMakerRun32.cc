// -*- C++ -*-
//
// Package:    Run3ScoutingAnalysisTools/ScoutingTreeMakerRun32
// Class:      ScoutingTreeMakerRun32
//
/**\class ScoutingTreeMakerRun32 ScoutingTreeMakerRun32.cc Run3ScoutingAnalysisTools/ScoutingTreeMakerRun32/plugins/ScoutingTreeMakerRun32.cc
...
class ScoutingTreeMakerRun32 : public edm::one::EDAnalyzer<edm::one::SharedResources> {
public:
  explicit ScoutingTreeMakerRun32(const edm::ParameterSet&);
  ~ScoutingTreeMakerRun32() override;
...
//
ScoutingTreeMakerRun32::ScoutingTreeMakerRun32(const edm::ParameterSet& iConfig):
...
ScoutingTreeMakerRun32::~ScoutingTreeMakerRun32() {
...
void ScoutingTreeMakerRun32::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
  using namespace std;
  ...
  */
  ...
  if (idx.size()>1) {
      cout<<"idx pt: "<<muonsH->at(idx[0]).pt()<<endl;
...
void ScoutingTreeMakerRun32::beginJob() {
...
void ScoutingTreeMakerRun32::endJob() {
  // please remove this method if not needed
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void ScoutingTreeMakerRun32::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(ScoutingTreeMakerRun32);
